...
class Spacewalk(object):
    ...
    def channel_exists(self, channel):
        ...
        '''
        try:
            self._api_call('channel.software.get_details', channel)
    ...
    def get_channel_details(self, channel):
        ...
        '''
        try:
            ret = self._api_call('channel.software.get_details', channel)
    ...
    def subscribe_base_channel(self, systemid, channel):
        ...
        subs = [x['label'] for x in
                self._api_call('system.list_subscribable_base_channels',
                               systemid)]
        if not channel:
